...
survp <- ggsurvplot(fit, data = meta_final_na, risk.table = TRUE, pval=TRUE, palette = c("red", "blue"))

ggsave(file = "~/index copy/_book/PhD_code/Spatial project/Results /BCA/Harmonised/survival.png")
